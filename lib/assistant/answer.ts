...
const entries: Entry[] = [
  ...
  },
  {
    ...
    answer: {
      ...
      ar: "AzeVSM AI is Azevsm Systems’ proprietary VSM-class artificial-intelligence technology, purpose-built for AzevsmAI. Its calculation result is not generated by an LLM and does not depend on free-form language-model generation.",
      zh: "AzeVSM AI is Azevsm Systems’ proprietary VSM-class artificial-intelligence technology, purpose-built for AzevsmAI. Its calculation result is not generated by an LLM and does not depend on free-form language-model generation.",
  ...
  },
  {
    ...
    answer: {
      ...
      ar: "Use Home, Platform, Products, Technology, White Box, Trust and Company. Contact and partnership are in the header. Legal pages are in the footer.",
      zh: "Use Home, Platform, Products, Technology, White Box, Trust and Company. Contact and partnership are in the header. Legal pages are in the footer.",
