...
export const services: ServiceRecord[] = [
  ...
  },
  {
    ...
    labels: {
      ...
      en: "In-Depth Governance Analysis",
      az: "Dərinləşdirilmiş idarəetmə təhlili",
  ...
  },
  {
    ...
    reviewDate: "2026-09-16",
    labels: {
      ru: "Устойчивость и внешнее воздействие",
      en: "Sustainability and External Impact",
      az: "Dayanıqlılıq və xarici təsir",
